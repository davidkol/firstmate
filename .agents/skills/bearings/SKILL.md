...
2. **Recently Landed** - the bounded current recent-completions baseline: merged PRs, completed scouts, and finished merges that landed without a PR, across the main fleet and every registered secondmate home.
