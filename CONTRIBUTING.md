...
- This repo is a template for running a firstmate orchestrator agent.
  `AGENTS.md` is the agent's main job description and names when to load bundled firstmate skills; `CLAUDE.md` is a regular file that imports it with `@AGENTS.md`, and `.claude/skills` is a symlink to `.agents/skills`.
...
[ "$(cat CLAUDE.md)" = $'<!-- Points Claude at AGENTS.md via import; edit AGENTS.md, not this file. -->\n@AGENTS.md' ]
