...
# home's startup-memory curation, and primary config/herdr-presentation-spaces
...
# downstream. config/backend is likewise NOT in the list: this fleet pins a
# home's runtime backend locally (see AGENTS.md section 2).
#
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness backlog-backend herdr-presentation-spaces startup-memory-budget}"
