...
- Martyrdome's canonical path is `/Users/davidkol/projects/Godot/Martyrdome`.
...
- Martyrdome [validated-main +yolo] - Godot action game, boss encounters
  path: /Users/davidkol/projects/Godot/Martyrdome
```
...
Martyrdome migrates to `/Users/davidkol/projects/Godot/Martyrdome` with `validated-main` delivery.
